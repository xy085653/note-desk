...
class TodoItem(QWidget):
    ...
    def __init__(self, todo_id: str, text: str = "", done: bool = False, parent=None):
        ...
        self.btn_delete.setStyleSheet("color: rgba(0,0,0,0.3);")
...
class TodoListWidget(QWidget):
    ...
    def __init__(self, card_id: str = "", parent=None):
        ...
        self.header.setStyleSheet("color: rgba(0,0,0,0.25); font-size: 11px;")
    ...
    def _create_item(self, todo_id: str, text: str, done: bool):
        ...
        item.deleted.connect(lambda tid: self.todo_deleted.emit(tid))
